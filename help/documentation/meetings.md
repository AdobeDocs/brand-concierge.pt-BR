---
title: Configurar e Configurar Reserva de Reunião
description: Saiba como configurar a reserva de reunião no Adobe Brand Concierge, incluindo conexões de calendário, disponibilidade, acesso de membros e análise de desempenho.
level: Beginner
role: User,Admin
...
1. Selecione **[!UICONTROL Sales Qualifier]**.
...
1. Escolha as configurações desejadas.
   ...
   >[!NOTE]
   >
   >Para adicionar mais opções de tempo, clique no sinal de mais (![ícone de sinal de mais](assets/icon-plus-sign.png)).
